...
- [Add New Order](#add-new-order-ordersaddorder)
- [Add Multiple Orders](#add-multiple-orders-ordersaddmultipleorders)
- [V2-Add Multiple Orders](#v2-add-multiple-orders-ordersv2addmultipleorders)
- [Update Order](#update-order-ordersupdateorder)
- [Cancel Order](#cancel-order-orderscancelorder)
- [Get Order Details](#get-order-details-ordersorderdetails)
- [Get Order Details By ID's](#get-order-details-by-ids-ordersorderdetails_by_ids)
- [Get Orders History](#get-orders-history-ordersorders_history_by_ids)
- [List All Orders](#list-all-orders-orderslist)
